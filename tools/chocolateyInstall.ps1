...
$packageArgs = @{
  ...
  url64          = 'http://us.download.nvidia.com/Windows/551.76/551.76-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'bf8dea246bceafdfb4b68b242b4fcb15a479bd944f6e3ba66feada31593ae524'
