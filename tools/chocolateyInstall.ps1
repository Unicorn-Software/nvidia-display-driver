...
$packageArgs = @{
  ...
  url64          = 'http://us.download.nvidia.com/Windows/545.92/545.92-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'a6bc27149860c34f88327de36699e891ac8374d71dc663e0cb0806c3771ccf01'
...
If ( [System.Environment]::OSVersion.Version.Major -ne '10' ) {
  $packageArgs['url64']      = 'http://us.download.nvidia.com/Windows/474.44/474.44-desktop-win8-win7-64bit-international.exe'
