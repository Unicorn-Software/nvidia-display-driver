...
$packageArgs = @{
  ...
  url64          = 'http://us.download.nvidia.com/Windows/546.17/546.17-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '74e53f0648015bdadd1efb2c45b5422cef47d7f2f9b5a2f2af497561e1bfcc28'
