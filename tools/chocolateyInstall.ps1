...
$packageArgs = @{
  ...
  url64          = 'http://us.download.nvidia.com/Windows/545.84/545.84-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '4a4d75dd8120ced91cd221cc64c80a4ea267c9a30a9c875fdb790ff3489def28'
