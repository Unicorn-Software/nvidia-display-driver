...
$packageArgs = @{
  ...
  url64          = 'http://us.download.nvidia.com/Windows/546.29/546.29-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '8f5164893db688dbc7b234e55a7d8ddd9974cb3ed6e9923ec76af1411c45fb68'
