...
$packageArgs = @{
  ...
  url64          = 'http://us.download.nvidia.com/Windows/551.52/551.52-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'bd19f3333334a76b7329cd19bd1f2a50a177965c33e8b4553d03ac27ef10d02a'
